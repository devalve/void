...
try {
    ...
    for (const k of ["iceRelayUdp", "iceRelayTcp", "iceRelayTls"]) {
        if (typeof loaded[k] === "number") stats[k] = loaded[k];
    }
    ...
    if (loaded.daily && typeof loaded.daily === "object") {
        for (const [k, v] of Object.entries(loaded.daily)) {
            ...
            stats.daily[k] = {
                ...
                iceRelayUdp: +v.iceRelayUdp || 0,
                iceRelayTcp: +v.iceRelayTcp || 0,
                iceRelayTls: +v.iceRelayTls || 0,
